...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "my btn btn-secondary");
    			add_location(button, file$4, 4, 0, 41);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['cardId'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Card> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => console.log(`Card clicked: ${cardId}`);

    	$$self.$$set = $$props => {
    		if ('cardId' in $$props) $$invalidate(0, cardId = $$props.cardId);
    	};

    	$$self.$capture_state = () => ({ cardId });
    	...
    	return [cardId, click_handler];
    }

    class Card extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { cardId: 0 });
    ...
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(9:2) {#each cards as card (card)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-4rv1gq");
    			add_location(div, file$3, 7, 0, 189);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let gridSize = 6;
    	let cards = Array.from({ length: gridSize * gridSize }, (_, i) => i);
    	...
    	$$self.$capture_state = () => ({ Card, gridSize, cards });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$2, 80, 0, 1931);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text("Site under construction 🏗️");
    			attr_dev(div, "class", "exit-note alert alert-success shadow-sm " + (/*isVisible*/ ctx[0] ? '' : 'hidden') + " svelte-1isoyh1");
    			attr_dev(div, "role", "alert");
    			add_location(div, file$1, 46, 0, 1073);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	exitnote = new ExitNote({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(matrix, main, null);
    			append_dev(main, t);
    			mount_component(exitnote, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ GameBoard, Matrix, ExitNote });
    	return [];
    }
