...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			img = element("img");
    			attr_dev(div0, "class", div0_class_value = "card-face card-face-front " + /*color*/ ctx[0] + " svelte-hfinwn");
    			add_location(div0, file$4, 51, 2, 1057);
    			if (!src_url_equal(img.src, img_src_value = /*rsc*/ ctx[1].img)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Card image");
    			attr_dev(img, "class", "svelte-hfinwn");
    			add_location(img, file$4, 54, 4, 1160);
    			attr_dev(div1, "class", "card-face card-face-back svelte-hfinwn");
    			add_location(div1, file$4, 53, 2, 1117);
    			attr_dev(div2, "class", "card svelte-hfinwn");
    			toggle_class(div2, "card-finished", /*finished*/ ctx[3]);
    			toggle_class(div2, "flipped", /*flipped*/ ctx[2]);
    			add_location(div2, file$4, 50, 0, 956);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div2, "click", /*cardClicked*/ ctx[4], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*color*/ 1 && div0_class_value !== (div0_class_value = "card-face card-face-front " + /*color*/ ctx[0] + " svelte-hfinwn")) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function dispatchShown() {
    		dispatch('shown', {
    			...
    			"cardFinishedCallback": () => {
    				$$invalidate(3, finished = true);
    			},
    	...
    	$$self.$$.on_mount.push(function () {
    		if (cardId === undefined && !('cardId' in $$props || $$self.$$.bound[$$self.$$.props['cardId']])) {
    			console_1.warn("<Card> was created without expected prop 'cardId'");
    		}

    		if (color === undefined && !('color' in $$props || $$self.$$.bound[$$self.$$.props['color']])) {
    			console_1.warn("<Card> was created without expected prop 'color'");
    		}

    		if (rsc === undefined && !('rsc' in $$props || $$self.$$.bound[$$self.$$.props['rsc']])) {
    			console_1.warn("<Card> was created without expected prop 'rsc'");
    		}
    	});
    	...
    	$$self.$$set = $$props => {
    		if ('cardId' in $$props) $$invalidate(5, cardId = $$props.cardId);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('finished' in $$props) $$invalidate(3, finished = $$props.finished);
    	...
    	return [color, rsc, flipped, finished, cardClicked, cardId];
    }

    class Card extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { cardId: 5, color: 0, rsc: 1 });
    ...
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(65:6) {#each cards as card (card)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container svelte-1o9rxor");
    			add_location(div0, file$3, 63, 4, 1653);
    			attr_dev(div1, "class", "outer-container svelte-1o9rxor");
    			add_location(div1, file$3, 62, 0, 1619);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
